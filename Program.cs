        ...
        case "3":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                ...
                do
                {
                    ...
                    {
                        int storage;
                        Console.WriteLine($"Please enter an age for animal with id {ourAnimals[i, 0]}");
                        readResult = Console.ReadLine();

                        if (readResult == null) continue;
                        if (int.TryParse(readResult, out storage) == false) continue;
                    ...
                    {
                        Console.WriteLine($"Please enter a physical description for animal with id {ourAnimals[i, 0]}");
                        readResult = Console.ReadLine();
                        if (readResult == null) continue;
            ...
            Console.WriteLine("Great job! You updated all of the pets missing information :)");
            Console.WriteLine("Press the Enter key to continue.");
            readResult = Console.ReadLine();
            break;
